...
class Problemtypes_List_Table extends WP_List_Table {
	...
	public function prepare_items() {
		...
		global $wpdb ;
		$problemtypes_table = $wpdb->prefix.'oj_problemtypes' ;

		$columns = $this->get_columns() ;
		$hidden = array() ;
		$sortable = array() ;
		$this->_column_headers = array($columns,$hidden,$sortable) ;
		$this->items = $wpdb->get_results("SELECT id,name FROM $problemtypes_table ORDER BY id ASC",ARRAY_A) ;
	}
